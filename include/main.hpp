...
enum ExtremeGear : u8 {
	...
	CoverP, HangOn, SuperHangOn, Darkness, Grinder, AdvantageS, AdvantageF, AdvantageP, Cannonball, TestGear,
	TGear2, TGear3, TGear4, TGear5, TGear6, TGear7, TGear8, TGear9, TotalGearAmount
};
