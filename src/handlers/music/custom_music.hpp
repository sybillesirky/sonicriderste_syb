...
#define STAGE_MUSIC_COUNT 64
#define MENU_MUSIC_COUNT 31
#define RACE_END_MUSIC_COUNT 19
#define BATTLE_MUSIC_COUNT 12

global void PlayADX(void* gpasAdxtHandle_Bgm, const char[]);
global void* gpasAdxtHandle_Bgm;
global u32 bss_CustomMusicID;
global char bss_SuperHangOn[];
global char* lbl_001E99BC[];
